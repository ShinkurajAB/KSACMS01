...
namespace SwitchCMS.Component.Pages.Dashboard.CompanyManagement
{
    public partial class CompanyManagement
    {
        ...
        string CRCertificateURL = string.Empty;
        string NationalIdUrl= string.Empty;
        string VatCertificateUrl= string.Empty;
        string OtherCertificateUrl= string.Empty;
        #endregion
        ...
        protected override async void OnAfterRender(bool firstRender)
        {
            if (firstRender)
            {
                ...
                await JS.InvokeVoidAsync("attachmentAccordion");
        ...
        {
            await JS.InvokeVoidAsync("showEditCompanyManagementModal");
        }
        #endregion
